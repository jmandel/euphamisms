...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "public/fonts/fY6k21F1QT2c_Oc3HRNDwiYE0-AqJ3nfInTTiDXDjU4.woff2";

/***/ }),
/* 5 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "public/fonts/fY6k21F1QT2c_Oc3HRNDwo4P5ICox8Kq3LLUNMylGO4.woff2";
...
/***/ (function(module, exports) {
	...
	var _user$project$Main$bobGuess = F2(
		function (word, w) {
			return _elm_lang$core$Native_Utils.eq(w, word) ? _elm_lang$core$Native_Utils.update(
				word,
				{bobGuessed: !word.bobGuessed}) : w;
		});
	var _user$project$Main$aliceGuess = F2(
		function (word, w) {
			return _elm_lang$core$Native_Utils.eq(w, word) ? _elm_lang$core$Native_Utils.update(
				word,
				{aliceGuessed: !word.aliceGuessed}) : w;
		});
				...
				_elm_lang$core$Array$toList(
					A3(
						...
						A2(
							...
							_elm_lang$core$Array$fromList(pile)),
						A3(
							_elm_lang$core$List$map2,
							F2(
								function (v0, v1) {
	...
	var _user$project$Main$Model = F6(
		function (a, b, c, d, e, f) {
			return {viewAs: a, hour: b, cards: c, isSpymaster: d, wantHints: e, history: f};
		});
		...
		return _elm_lang$core$List$concat(
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$core$List$repeat, neutralCount, _user$project$Main$Neutral),
						_1: {ctor: '[]'}
					}
				}
			});
	...
	var _user$project$Main$dealCards = F3(
		function (sessionSeed, seed, hour) {
			var picks = A2(
			...
			return A4(
				...
				F3(
					function (a, b, p) {
						return {aliceLabel: a, bobLabel: b, word: p, aliceGuessed: false, bobGuessed: false};
					}),
				aliceLabelKey,
				bobLabelKey,
				picks);
	...
	var _user$project$Main$card = F5(
		function (viewAsPlayer, isSpymaster, wantHints, probs, word) {
			...
			var currentPlayerLabel = _elm_lang$core$Native_Utils.eq(viewAsPlayer, _user$project$Main$Alice) ? _elm_lang$core$Basics$toString(word.aliceLabel) : _elm_lang$core$Basics$toString(word.bobLabel);
			var distributionHints = function () {
				var colorProbs = A2(
					_elm_lang$core$Maybe$withDefault,
					_elm_lang$core$Dict$fromList(
						{ctor: '[]'}),
					A2(_elm_lang$core$Dict$get, currentPlayerLabel, probs));
				return A2(
					_elm_lang$core$Basics_ops['++'],
					{
						ctor: '::',
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('distribution-hints'),
								_1: {ctor: '[]'}
							},
							A2(
								_elm_lang$core$List$map,
								function (color) {
									return A2(
										_elm_lang$html$Html$span,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class(
												A2(_elm_lang$core$Basics_ops['++'], 'probability-', color)),
											_1: {
												ctor: '::',
																...
																_elm_lang$core$Basics$toString(
																	function (v) {
																		...
																		A2(
																			_elm_lang$core$Maybe$withDefault,
																			0,
																			A2(_elm_lang$core$Dict$get, color, colorProbs)))),
																'em')
														},
														_1: {ctor: '[]'}
													}),
										...
										function (color) {
											var colorCount = A2(
												...
												A2(
													...
													colorProbs));
											return _elm_lang$core$Native_Utils.cmp(colorCount, 0) > 0;
										},
										{
											ctor: '::',
											...
											_1: {
												ctor: '::',
												_0: _user$project$Main$Neutral,
												_1: {
													ctor: '::',
													_0: _user$project$Main$Black,
													_1: {ctor: '[]'}
												}
											}
										})))),
			...
			var team = guessedGreen ? 'team-Green' : (guessedBlack ? 'team-Black' : ((word.aliceGuessed && (word.bobGuessed && _elm_lang$core$Native_Utils.eq(word.aliceLabel, word.bobLabel))) ? A2(
				_elm_lang$core$Basics_ops['++'],
				'team-',
				_elm_lang$core$Basics$toString(word.aliceLabel)) : (((_elm_lang$core$Native_Utils.eq(viewAsPlayer, _user$project$Main$Bob) && isSpymaster) || (_elm_lang$core$Native_Utils.eq(viewAsPlayer, _user$project$Main$Alice) && (!isSpymaster))) ? bobLabel : aliceLabel)));
			return A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
				...
				A2(
					...
					(!_elm_lang$core$Native_Utils.eq(originalColor, '')) ? {
						...
						((!(isSpymaster || showBackground)) && wantHints) ? distributionHints : {ctor: '[]'})));
		});
		...
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				...
				_0: A2(
					...
					A2(_elm_lang$core$Task$perform, _elm_lang$core$Time$inHours, _elm_lang$core$Time$now)),
				_1: {ctor: '[]'}
			})
	};
	var _user$project$Main$ViewAs = function (a) {
	...
	var _user$project$Main$view = function (model) {
		...
		var probabilities = _elm_lang$core$Dict$fromList(
			A2(
				_elm_lang$core$List$map,
				function (l) {
					var opponentTotals = _elm_lang$core$Dict$fromList(
						A2(
							_elm_lang$core$List$map,
							function (_p22) {
								var _p23 = _p22;
								return {ctor: '_Tuple2', _0: _p23._0._1, _1: _p23._1};
							},
							l));
					var givenColor = A2(
						_elm_lang$core$Maybe$withDefault,
					...
					return {ctor: '_Tuple2', _0: givenColor, _1: opponentTotals};
				},
				A2(
					...
					F2(
						function (_p27, _p26) {
							var _p28 = _p27;
							var _p29 = _p26;
							return _elm_lang$core$Native_Utils.eq(_p28._0._0, _p29._0._0);
						}),
					A2(
						_elm_lang$core$List$map,
						function (_p30) {
							...
							return {
								...
								_0: {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Basics$toString(_p31._0._0),
									_1: _elm_lang$core$Basics$toString(_p31._0._1)
								},
								_1: _p31._1
							};
						},
		...
		var turns = _elm_lang$core$Tuple$first(
			A3(
				_elm_lang$core$List$foldl,
				F2(
					function (player, _p32) {
						var _p33 = _p32;
						var _p35 = _p33._0;
						var _p34 = _p33._1;
						return _elm_lang$core$Native_Utils.eq(player, _p34) ? {ctor: '_Tuple2', _0: _p35, _1: _p34} : {ctor: '_Tuple2', _0: _p35 + 1, _1: player};
					}),
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						A2(
							_elm_lang$core$List$map,
							A4(_user$project$Main$card, model.viewAs, model.isSpymaster, model.wantHints, probabilities),
							model.cards)),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('fa fa-eye fa-arrow-circle-o-left prev-game'),
								_1: {
									ctor: '::',
									_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-label', 'true'),
									_1: {
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('fa fa-arrow-circle-o-right next-game'),
									_1: {
										ctor: '::',
										_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-label', 'true'),
										_1: {
